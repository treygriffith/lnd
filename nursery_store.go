...
type NurseryStore interface {
	...
	// HeightsBelowOrEqual returns the lowest non-empty height bucket in the
	// height index, that exists below the provided upper bound.
...
// index below the provided upper bound.
