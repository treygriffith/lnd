...
type config struct {
	...
	HodlHTLC           bool `long:"hodlhtlc" description:"Activate the hodl HTLC mode.  With hodl HTLC mode, all incoming HTLCs will be accepted by the recieving node, but no attempt will be made to settle the payment with the sender."`
